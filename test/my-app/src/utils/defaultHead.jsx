...
import { StyledSEO } from "@/styles/index.styles";

export default function DefaultHead({ title, content, seo }) {
  return (
    <React.Fragment>
      <Head>
        <title>{title}</title>
        ...
        <meta charSet="UTF-8" />
        {/* 모바일 뷰 조절 1. width가 웹 사이트를 보고있는 장치와 동일, 2.웹 사이트의 배율이 100%로 설정 */}
